...
RECIPES = {
    ...
    "Cupcake":    {"Flour": 0.05, "Butter": 0.03,  "Sugar": 0.04, "Eggs": 0.5, "Cocoa": 0.01},
    "Jar Cake":   {"Flour": 0.08, "Butter": 0.05,  "Sugar": 0.06, "Eggs": 0.5, "Cocoa": 0.03},
    ...
    "Croissant":  {"Flour": 0.06, "Butter": 0.035, "Sugar": 0.01, "Eggs": 0.2, "Cocoa": 0.00},
    "Cookies":    {"Flour": 0.02, "Butter": 0.015, "Sugar": 0.015,"Eggs": 0.1, "Cocoa": 0.005},
    "Muffin":     {"Flour": 0.05, "Butter": 0.03,  "Sugar": 0.04, "Eggs": 0.3, "Cocoa": 0.00},
}
...
if st.session_state.get("bw_last_page") != selected:
    st.session_state["bw_last_page"] = selected
    components.html(
        """
        <script>
...
if selected == "Tomorrow's Bake Plan":
    ...
    c1, c2, c3 = st.columns(3)
    with c1:
        plan_date = st.date_input("Date", datetime.today())
